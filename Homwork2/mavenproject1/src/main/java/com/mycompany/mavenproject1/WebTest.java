...
/**
 * Example of the OAuth client credentials flow using the Apache OAuth2 client.
 */
public class WebTest {
    /**
     * URL for requesting OAuth access tokens.
     */
    public static final String TOKEN_REQUEST_URL = "https://www.bungie.net/en/OAuth/Authorize";

    /**
     * Client ID of your client credential.  Change this to match whatever credential you have created.
     */
    public static final String CLIENT_ID = "22601";

    /**
     * Client secret of your client credential.  Change this to match whatever credential you have created.
     */
    public static final String CLIENT_SECRET =
            "3HG6EfKTVbthpfSHEzpOqPWr4z1skmQyMuEvrL0w7Ms";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            request.setLocationUri("https://www.bungie.net/en/oauth/authorize?client_id=22601&response_type=code&state=6i0mkLx79Hp91nzWVeHrzHG4");
...
//                    .buildQueryMessage();
            System.out.println("locUri"+request.getLocationUri());
